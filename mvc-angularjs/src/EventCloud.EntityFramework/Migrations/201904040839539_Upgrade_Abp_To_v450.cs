namespace EventCloud.Migrations
{
    ...
    public partial class Upgrade_Abp_To_v450 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateIndex("dbo.AppEventRegistrations", "TenantId");
            CreateIndex("dbo.AppEvents", "TenantId");
            CreateIndex("dbo.AppEvents", "IsDeleted");
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.AppEvents", new[] { "IsDeleted" });
            DropIndex("dbo.AppEvents", new[] { "TenantId" });
            DropIndex("dbo.AppEventRegistrations", new[] { "TenantId" });
